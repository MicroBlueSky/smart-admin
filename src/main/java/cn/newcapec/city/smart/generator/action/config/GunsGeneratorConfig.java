package cn.newcapec.city.smart.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("cn.newcapec.city.smart.admin.common.persistence.model");
        packageConfig.setMapper("cn.newcapec.city.smart.admin.common.persistence.dao");
        packageConfig.setXml("cn.newcapec.city.smart.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("cn.newcapec.city.smart.admin");
        contextConfig.setCoreBasePackage("cn.newcapec.city.smart.core");
