package cn.newcapec.city.smart.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = ".city.smart";
    private String coreBasePackage = "cn.newcapec.city.smart.core";
    private String modelPackageName = "cn.newcapec.city.smart.modular.system.model";        //model的包名
    private String modelMapperPackageName = "cn.newcapec.city.smart.modular.system.dao";    //model的dao
