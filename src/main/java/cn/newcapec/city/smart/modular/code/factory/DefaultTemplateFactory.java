package cn.newcapec.city.smart.modular.code.factory;


import cn.newcapec.city.smart.core.core.CoreFlag;
import cn.newcapec.city.smart.core.core.util.ToolUtil;
import cn.newcapec.city.smart.generator.action.model.GenQo;
import cn.newcapec.city.smart.SmartAdminApplication;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setProjectPackage(SmartAdminApplication.class.getPackage().getName());
